...
ALTER TABLE t_users
    ...
    ADD CONSTRAINT uc_t_users_c_username UNIQUE (c_username);

CREATE TABLE IF NOT EXISTS t_users_roles
(
    t_users_id BIGINT       NOT NULL,
    c_role     VARCHAR(255) NOT NULL,
    CONSTRAINT pk_t_users_roles PRIMARY KEY (t_users_id, c_role)
);

ALTER TABLE t_users_roles
    ADD CONSTRAINT fk_t_users_roles_on_c_user FOREIGN KEY (t_users_id) REFERENCES t_users (id) ON DELETE CASCADE ON UPDATE NO ACTION;
